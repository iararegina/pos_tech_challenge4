...
with st.container():
    ...
    st.write("Para a previsão do preço por barril de petróleo foi utilizado Séries Temporais, dentre os modelos o ARIMA foi escolhido por apresentar um melhor desempenho ante aos demais.")
